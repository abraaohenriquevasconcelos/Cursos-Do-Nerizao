...
namespace Nerizao_Aula_92
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Button_CoresSelecionadas_Click(object sender, EventArgs e)
        {
            foreach(ListItem listItem in ListBox_Cores.Items)
            {
                if (listItem.Selected)
                    TextBox_CoresSelecionadas.Text += listItem.Text+"\n";
            }
        }
